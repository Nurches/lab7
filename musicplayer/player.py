...
musics = [f"songs/{i}" for i in os.listdir(r'C:\\Users\\admin\\Desktop\\labsPP\\lab7\\musicplayer\\songs') if '.mp3' in i]
images = [f"songs/{i}" for i in os.listdir(r'C:\\Users\\admin\\Desktop\\labsPP\\lab7\\musicplayer\\songs') if '.jpg' in i]
authors = {}
for i in musics:
...
mute_rect = mute_sc.get_rect(center=(100, 500))
#unmute_rect = unmute_sc.get_rect(center=)
