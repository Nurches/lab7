...
clock_sc = pygame.image.load('clock.png').convert_alpha()
leftarm_sc = pygame.image.load('leftarm.png').convert_alpha()
rightarm_sc = pygame.image.load('rightarm.png').convert_alpha()
